...
cd "$ROOT"
python3 -m py_compile acceptance/tests/conftest.py acceptance/tests/fixtures.py acceptance/tests/test_um_runtime.py acceptance/tests/test_di_runtime.py acceptance/tests/test_pp_runtime.py acceptance/tests/test_cr_runtime.py acceptance/tests/test_cl_ex_runtime.py acceptance/tests/test_cl_va_runtime.py acceptance/tests/test_pr_runtime.py acceptance/tests/test_sec_runtime.py acceptance/tests/test_in_runtime.py acceptance/tests/test_or_sr_runtime.py acceptance/tests/test_lifecycle_runtime.py acceptance/tests/test_operational_runtime.py acceptance/tools/backup_restore_probe.py acceptance/tools/timing_probe.py acceptance/tools/slo_evaluation.py acceptance/tools/load_qualification.py acceptance/tools/ocr_evaluation.py acceptance/tools/sanitize_logs.py acceptance/tools/wait_for_stack.py evaluation/bootstrap_corpus.py evaluation/intake_document.py evaluation/validate_corpus_manifest.py backend/app/main.py backend/app/api/auth.py backend/app/api/documents.py backend/app/api/shares.py backend/app/schemas/documents.py backend/app/workers/celery_app.py backend/alembic/versions/0008_classification_review.py backend/alembic/versions/0009_tags_collections.py backend/alembic/versions/0010_reminder_preferences.py backend/alembic/versions/0011_document_versions.py backend/alembic/versions/0012_share_links.py backend/alembic/versions/0013_version_group_uniqueness.py backend/tests/test_share_link_contracts.py backend/tests/test_operational_readiness_contracts.py backend/tests/test_backup_restore_probe_contracts.py backend/tests/test_http_metrics_contracts.py backend/tests/test_slo_evaluation_contracts.py backend/tests/test_load_qualification_contracts.py backend/tests/test_security_headers_contracts.py backend/app/services/http_metrics.py backend/app/services/integrity_conflicts.py backend/app/services/rate_limiter.py backend/app/services/readiness.py backend/app/services/ocr.py backend/app/services/analysis.py backend/app/services/sensitivity.py backend/app/services/reminders.py backend/app/services/file_validation.py
python3 - <<'PY'
import json
import re
