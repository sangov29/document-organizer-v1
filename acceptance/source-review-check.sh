...
assert 'Evidence: GitHub Runtime Acceptance #1 under the renamed workflow (project sequence Run #65)' in project_status
assert '`fed1de021506b0069c8f39d8083bca4652baafce`' in project_status
